...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    { url: baseUrl, lastModified: new Date('2026-09-23'), changeFrequency: 'weekly', priority: 1 },
    { url: `${baseUrl}/talleres`, lastModified: new Date('2026-09-23'), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/talleres/tulipanes`, lastModified: new Date('2026-09-23'), changeFrequency: 'weekly', priority: 0.85 },

...
export const metadata: Metadata = {
  title: 'Contacto — Reserva tu Taller de Acuarela | Josefina Fainé',
  description:
    'Contacta a Josefina Fainé para reservar tu lugar en los talleres de acuarela y arteterapia en Santiago. WhatsApp y formulario de contacto.',
  alternates: { canonical: '/contacto' },
  openGraph: {
    siteName: 'Josefina Fainé',
    title: 'Contacto — Reserva tu Taller de Acuarela',
    description: 'Contacta a Josefina Fainé para reservar tu lugar en los talleres de acuarela.',

...
export const WORKSHOPS: Workshop[] = [
  ...
  },
  {
    ...
    tagline: 'Dos fechas disponibles · Apto para principiantes',
    description: 'Una jornada para pintar magnolias en acuarela, apta para principiantes en la técnica. Elige entre la mañana del viernes o la tarde del domingo. Materiales y coffee break incluidos, en Providencia (metro Los Leones). Máximo 6 cupos.',
    date: '',
    time: '',
    sessions: [
      {
    ...
    imageFit: 'contain',
    ctaLink: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hola Josefina! Quiero reservar mi cupo en el Workshop Magnolias en Acuarela. ¿Tienen disponibilidad para el viernes 2 o el domingo 4 de octubre?')}`,
    badge: 'Máximo 6 cupos',
    detailLink: '/talleres/magnolias',
    seoTitle: 'Workshop Magnolias en Acuarela en Providencia | Josefina Fainé',
    seoDescription: 'Workshop Magnolias en Acuarela: viernes 2 o domingo 4 de octubre de 2026 en Providencia. Apto para principiantes. Materiales y coffee break incluidos. $33.000.',
  ...
  },
  {
    id: 'lavandas',
    slug: 'lavandas',
    name: 'Arte como Terapia · Lavandas en Acuarela',
    tagline: 'Experiencia sensorial · Lavandas naturales',
    description: 'Una experiencia para conectar con la calma a través del agua, las lavandas naturales y la acuarela. Pintarás tu propia obra en un encuentro sensorial, con materiales y coffee break incluidos, en Providencia (metro Los Leones).',
    date: '',
    time: '',
    sessions: [
      {
    ...
    image: '/fotos/workshop-lavandas.jpeg',
    imageFit: 'contain',
    ctaLink: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hola Josefina! Quiero reservar mi cupo en Arte como Terapia · Lavandas en Acuarela del domingo 4 de octubre, de 11:00 a 14:00 hrs.')}`,
    badge: 'Máximo 6 cupos',
    detailLink: '/talleres/lavandas',
    seoTitle: 'Lavandas en Acuarela · Arte como Terapia en Providencia | Josefina Fainé',
    seoDescription: 'Arte como Terapia · Lavandas en Acuarela: domingo 4 de octubre de 2026, de 11:00 a 14:00 hrs, en Providencia. Experiencia sensorial con materiales y coffee break incluidos. $37.000.',
    heading: 'Conecta con la calma a través de las lavandas y la acuarela',
    aprenderas: [
      'Explorar las lavandas naturales a través de una experiencia sensorial',
      'Conectar con la calma mediante el agua y la acuarela',
      'Crear una pintura en acuarela inspirada en las lavandas',
      'Una obra terminada para llevar',
    ],
    incluye: [
      'Todos los materiales para la sesión',
      'Lavandas naturales para la experiencia sensorial',
      'Coffee break',
  ...
  },
  {
    id: 'animales-pop',
    slug: 'animales-pop',
    name: 'Workshop de Acuarela y Técnica Mixta · Animales Pop',
    tagline: 'Sesión única · Animales Pop',
    description: 'Pinta tu propio animal con colores vibrantes y dale vida con tu creatividad combinando acuarela y técnica mixta. No necesitas experiencia previa. Materiales y coffee break incluidos, en Providencia (metro Los Leones).',
    date: '',
    time: '',
    sessions: [
      {
    ...
    groupSize: 6,
    level: 'Sin experiencia previa',
    image: '/fotos/taller-animales-pop.jpeg',
    imageFit: 'contain',
    ctaLink: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hola Josefina! Quiero reservar mi cupo en el Workshop Animales Pop del domingo 13 de septiembre.')}`,
    badge: 'Máximo 6 cupos',
    detailLink: '/talleres/animales-pop',
    seoTitle: 'Taller Animales Pop en Acuarela y Técnica Mixta | Santiago',
    seoDescription: 'Workshop Animales Pop de acuarela y técnica mixta en Santiago. Pinta tu propio animal con colores vibrantes. Sin experiencia previa, con materiales y coffee break incluidos.',
    heading: 'Pinta tu propio animal con colores vibrantes',
    intro: 'Una tarde para crear un animal lleno de color y personalidad combinando acuarela y técnica mixta. No necesitas experiencia previa: solo ganas de relajarte, disfrutar y darle vida a tu creatividad.',
    aprenderas: [
      'A combinar acuarela y técnica mixta en una misma obra',
      'A construir un animal con color, contraste y personalidad',
      'A explorar capas, texturas y detalles expresivos',
      'Una obra personal de tu animal pop para llevar',
    ],
    incluye: [
      'Todos los materiales para crear tu obra',
      'Coffee break',
  ...
  },
  {
    ...
    groupSize: 6,
    level: 'Todos los niveles',
    image: '/fotos/alumnas/obra-24.jpeg',

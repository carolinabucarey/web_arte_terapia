...
export const WORKSHOPS: Workshop[] = [
  ...
  },
  {
    ...
    ctaLink: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hola Josefina! Quiero saber más sobre el Workshop Cerezo en Flor en Acuarela.')}`,
    badge: 'Próxima fecha por confirmar',
  },
  {
    id: 'principiantes',
    slug: 'principiantes',

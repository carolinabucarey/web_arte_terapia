...
export const WORKSHOPS: Workshop[] = [
  ...
  },
  {
    ...
    ctaLink: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hola Josefina! Quiero reservar mi cupo en el Workshop Marmoleado en Papel del viernes 29 de mayo.')}`,
    badge: 'Cupos limitados',
  },
  {
    id: 'grupos-cerrados',

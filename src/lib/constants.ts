...
export const WORKSHOPS: Workshop[] = [
  ...
  },
  {
    ...
    ctaLink: `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent('Hola Josefina! Quiero reservar mi cupo en el Workshop de Cócteles en Acuarela del domingo 13 de septiembre.')}`,
    badge: 'Cupos limitados',

...
export default function WorkshopCard(workshop: Workshop) {
  ...
  return (
    <div id={id} className="group scroll-mt-28 h-full">
      <div className="h-full flex flex-col bg-white rounded-card border border-border shadow-card group-hover:-translate-y-1 group-hover:shadow-card-hover group-hover:border-brand-lavender transition-all duration-300 ease-out overflow-hidden">
        {hasCarousel ? (

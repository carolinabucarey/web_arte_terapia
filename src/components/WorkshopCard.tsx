...
export default function WorkshopCard(workshop: Workshop) {
  ...
  return (
    <div id={id} className="scroll-mt-28 h-full flex flex-col bg-white rounded-card border border-border shadow-card hover:shadow-card-hover hover:border-brand-lavender transition-[box-shadow,border-color] duration-300 ease-out overflow-hidden">
      {hasCarousel ? (
